        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="container-form-create-post">
                    <form id="modal-form" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-span-full">
                            <label for="cover-photo" class="block text-sm font-medium leading-6 text-center">Imagem</label>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                        <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                            <input type="file" name="image_post" id="file-upload" class="sr-only">
                                        </label>
                                    </div>
                                    <p class="text-xs leading-5">Suportamos apenas PNG, JPG.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-full">
                            <label for="description-post-create" class="block text-sm font-medium leading-6 text-center">Descrição</label>
                            <div class="mt-2">
                            ...
                            <button class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-2" type="submit">Publicar</button>
                        </div>
                    </form>
                </div>
            </div>
